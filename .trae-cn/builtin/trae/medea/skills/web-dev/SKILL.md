...
5. **When you are in regular Agent Mode, after completing document generation, you MUST use NotifyUser tool to notify user, then end the session immediately.**
