...
1. **CRITICAL**: You MUST read `web-dev-guideline.md` (**located in the same directory as the SKILL.md file**, NOT in the user's project) and follow it BEFORE writing any code.
