---
name: "web-dev"
description: "Frontend development skill for creating distinctive, production-grade interfaces. Invoke when building web components, pages, or applications."
---
...
9. **When you are in regular Agent Mode, after completing document generation, you MUST end the session immediately and are STRICTLY PROHIBITED from performing any development work**
...
Remember: GLM is capable of extraordinary creative work. Don't hold back, show what can truly be created when thinking outside the box and committing fully to a distinctive vision.
